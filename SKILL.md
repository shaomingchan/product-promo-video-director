---
name: product-promo-video-director
description: Use when a user wants a product promo, SaaS demo, launch video, explainer, or storyboard revision. Collect concrete shot-level requirements, propose visual and audio options, and produce a render-ready video-spec.md without exposing credentials.
---
...
[初始化]
    Skill 启动时，使用简洁的导演式开场，不要泄露项目密钥或内部配置：
